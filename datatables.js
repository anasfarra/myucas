...
$.extend( true, $.fn.dataTable.defaults, {
    ...
    "oLanguage": {
        ...
        "sLengthMenu": "عرض _MENU_ سجل لكل صفحة",
        "sZeroRecords": "لا يوجد عناصر.",
        "sInfo": "عرض _START_ الى _END_ من _TOTAL_ المدخلات",
        "sInfoEmpty": "عرض 0 الى 0 من المدخلات",
        "sInfoFiltered": "(تصفيه _MAX_ من مجموع  الكلي للمدخلات)",
        "sinfoPostFix": "",
        "sInfoThousands": ",",
        "sSearch": "بحث",
        ...
        "sUrl": "",
        "oAria":{
            sSortAscending: ": جاهز لترتيب الأعمدة تصاعديا",
            sSortDescending: ": جاهز لترتيب الأعمدة تنازليا"
        },
        "oPaginate":{
            "sFirst": "الأول",
            "sLast": "الأخير",
...
$.extend( $.fn.dataTableExt.oPagination, {
	"bs_normal": {
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			$(nPaging).append(
				'<ul class="pagination">'+
					'<li class="prev disabled"><a href="#"><span class="fa fa-angle-right"></span>&nbsp;'+oLang.sPrevious+'</a></li>'+
					'<li class="next disabled"><a href="#">'+oLang.sNext+'&nbsp;<span class="fa fa-angle-left"></span></a></li>'+
				'</ul>'
			);
			var els = $('a', nPaging);
